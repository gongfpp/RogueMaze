...
- 阶段：P0 立项与预制作
- 当前版本：垂直切片灰盒 v0.2
- 已完成：三节点远征、自动拼路循环、尖刺/落石、节点卡牌奖励、胜负复盘、Windows/Linux 导出
- 当前连续工作：`WP-024 代表性音画` 与平台构建深化；真人试玩保持开放记录
...
当前灰盒操作：点击或拖动手牌到绿色格子；`R`/右键旋转；数字键 `1–4` 选牌；空格暂停。角色会在 4 秒后自动出发。完成三个节点即赢得远征；节点间选择一张奖励牌，途中需要处理尖刺和定时落石。
